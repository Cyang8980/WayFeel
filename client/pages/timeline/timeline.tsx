...
const Timeline = () => {
    const [posts, setPosts] = useState([
        { id: 1, title: "First Post", content: "This is my first post!", date: "2024-03-01" },
        { id: 2, title: "Learning Next.js", content: "Next.js is awesome!", date: "2024-03-05" },
        { id: 3, title: "Exploring Animations", content: "Framer Motion is really fun!", date: "2024-03-10" },
    ]);
        ...
        <div>
            ...
            {isSignedIn ? (
                ...
                <div className="flex justify-center items-center h-screen">
                    <p className="text-xl font-semibold">Please sign in to view the timeline.</p>
                </div>
            )}
        </div>
    );
